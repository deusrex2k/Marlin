...
#define Popup_Text_Color  0xD6BA  // Gray Popup font background color
#define Line_Color        0x3A6A  // Split line color
#define Rectangle_Color   0xF81F  // Purple square cursor color
#define Percent_Color     0xFE29  // Percentage color
#define BarFill_Color     0x10E4  // Fill color of progress bar
#define Select_Color      0x33BB  // Selected color

//https://chrishewett.com/blog/true-rgb565-colour-picker/
//0xEE2F = Light Yellow (Old Rectangle Color)
//0xFFE0 = Full Yellow
//0x07E0 = Full Green
//0x001F = FUll Blue
//0xF81F = Purple (Full red and blue)
//0xFE29 = Orange (Percentage Color) 
